...
# Config 1 - Bigquery config only for spark and local runners to access bigquery
...
runner_type, streaming_ind = ['SparkRunner',
...
dataflowrunner_config = {'project': 'qwiklabs-gcp-04-ccfab8a3c762',
                         'runner': 'DataflowRunner',
                         'jobname': 'test',
                         'temp_bucket': 'gs://qwiklabs-gcp-04-ccfab8a3c762/temp_bucket',
                         'staging_bucket': 'gs://qwiklabs-gcp-04-ccfab8a3c762/staging_bucket',
...
write_config_csv = {
    'filepath+filename': bucket_name + '/output/weather',
    'filesuffix': '.csv',
    'shard': 2,
    'shardtype': '-S-N',
    'header': None
...
# custom transformations (not part of framework)
